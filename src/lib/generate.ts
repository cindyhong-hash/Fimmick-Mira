...
export async function polishBriefToChinese(input: {
  ...
  const sys =
    ...
    "5. 如果有提供【實際產品內容】，擴寫嗰個背景/場景/氛圍一定要圍住呢個產品嘅實際內容嚟諗，唔可以無端加入天空、沙灘、大自然等同產品完全無關嘅通用場景。要具體：\n" +
    "   • 係食物／飲品：諗返呢款食物實際會有嘅配料、醬汁、擺盤、質感（例如朱古力蛋糕可以有朱古力醬淋面或屑碎、忌廉花邊；飲品可以有水珠、冰塊、蒸氣），唔好淨係講「食物特寫」呢種空泛講法。\n" +
    "   • 產品本身有明顯裝飾圖案／元素（例如花卉、圖騰、材質紋理）：場景可以呼應延伸呢啲元素（例如產品有玫瑰圖案，背景/道具可以加返呼應嘅玫瑰花瓣或花卉造型），令畫面同產品有視覺連貫，唔好完全獨立於產品設計。\n" +
    "6. 除非用戶原始指令明確要求人物，或者呢張圖本身係「真人寫實」類型，否則背景/場景預設**唔好加入人物**——食物、產品呢類特寫場景通常唔需要有人出現，加咗人反而分散主體。\n" +
    "7. 睇圖要仔細：如果【實際產品內容】有講到具體形狀/顏色/質感/圖案，擴寫時盡量呼應返呢啲具體細節，唔好只用「精緻」「質感」呢類空泛形容詞交代。";
