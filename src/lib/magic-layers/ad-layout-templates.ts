...
export const AD_LAYOUT_TEMPLATES: readonly AdLayoutTemplate[] = [
  ...
  },
  {
    ...
    zones: {
      text: { x: 0.09, y: 0.07, w: 0.75, h: 0.15 }, hero: { x: 0.24, y: 0.24, w: 0.52, h: 0.52 },
  ...
  },
  {
    ...
    zones: {
      text: { x: 0.58, y: 0.18, w: 0.35, h: 0.35 }, hero: { x: 0.05, y: 0.25, w: 0.50, h: 0.51 },
  ...
  },
  {
    ...
    zones: {
      text: { x: 0.09, y: 0.08, w: 0.64, h: 0.13 }, hero: { x: 0.24, y: 0.22, w: 0.52, h: 0.54 },
